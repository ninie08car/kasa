    ...
    <div className="about-container">
      ...
      <div className="about-collapses">
        <Collapse
          ...
          content={
            <p>
              Les annonces sur Kasa garantissent une fiabilité totale. Les
              photos sont conformes aux logements et toutes les informations
        ...
        <Collapse
          ...
          content={
            <p>
              ...
              à l'hôte qu'au locataire, cela permets à nos équipes de vérifier
              que les standares sont bien respectés.Nous organisons également
